...
$query_kategori = "SELECT id_kategori, nama FROM kategori";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <form action="utils/simpan-barang.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <img id="output" class="img-fluid" width="300">
                        <div class="mb-3">
                            <label for="gambar" class="form-label">Gambar</label>
                            <input type="file" class="form-control" name="gambar" id="gambar" onchange="previewImage(event)" required>
                        </div>
