...
$query = "SELECT COUNT(*) AS total_barang FROM barang"; // Perintah SQL untuk menghitung jumlah barang
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Barang</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_barang; ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
